...
var populateToptenTable = function(results) {
	...
	results.leagueStd.tableDataDelve.forEach(function(data) {
		if (counter <= 5) {
			...
			if (data.dead == true) {
				$('#table1 tbody').append(
						'<tr class = "deadChar">' + '<td>' + counter++
								+ '</td>' + '<td>' + toonName
								+ "'<i id='deadStatus'>(dead)</i>'" + '</td>'
								+ '<td><font color="' + classColor + '">'
								+ ascendancyIcon + '</font></td>' + '<td>'
								+ data.depth + '</td>' + '</tr>');
			} else {
				$('#table1 tbody').append(
						'<tr>' + '<td>' + counter++ + '</td>' + '<td>'
								+ toonName + '</td>' + '<td><font color="'
								+ classColor + '">' + ascendancyIcon
								+ '</font></td>' + '<td>' + data.depth
								+ '</td>' + '</tr>');
			}
		}
	});
	...
	counter = 1;
	results.leagueHC.tableDataDelve.forEach(function(data) {
		if (counter <= 5) {
			toonName = data.character;
			var accountLink = getPoeAccount(data.account)
			var ascendancyIcon = getAscendancyIcon(data.theClass);
	...
	counter = 1;
	results.leagueSFF.tableDataDelve.forEach(function(data) {
		if (counter <= 5) {
			toonName = data.character;
			var accountLink = getPoeAccount(data.account)
			var ascendancyIcon = getAscendancyIcon(data.theClass);
	...
	counter = 1;
	results.leagueHCSFF.tableDataDelve.forEach(function(data) {
		if (counter <= 5) {
			toonName = data.character;
			var accountLink = getPoeAccount(data.account)
			var ascendancyIcon = getAscendancyIcon(data.theClass);
	...
	counter = 1;
	results.leagueStd.tableDataUberLabTopTen.forEach(function(data) {
		if (counter <= 5) {
			toonName = data.character;
			var accountLink = getPoeAccount(data.account)
			var ascendancyIcon = getAscendancyIcon(data.theClass);
	...
	counter = 1;
	results.leagueHC.tableDataUberLabTopTen.forEach(function(data) {
		if (counter <= 5) {
			toonName = data.character;
			var accountLink = getPoeAccount(data.account)
			var ascendancyIcon = getAscendancyIcon(data.theClass);
	...
	counter = 1;
	results.leagueSFF.tableDataUberLabTopTen.forEach(function(data) {
		if (counter <= 5) {
			toonName = data.character;
			var accountLink = getPoeAccount(data.account)
			var ascendancyIcon = getAscendancyIcon(data.theClass);
	...
	counter = 1;
	results.leagueHCSFF.tableDataUberLabTopTen.forEach(function(data) {
		if (counter <= 5) {
			toonName = data.character;
			var accountLink = getPoeAccount(data.account)
			var ascendancyIcon = getAscendancyIcon(data.theClass);
	...
	counter = 1;
	results.leagueStd.tableDataRaceTo100.forEach(function(data) {
		if (counter <= 5) {
			toonName = data.character;
			var accountLink = getPoeAccount(data.account)
			var ascendancyIcon = getAscendancyIcon(data.theClass);
	...
	counter = 1;
	results.leagueHC.tableDataRaceTo100.forEach(function(data) {
		if (counter <= 5) {
			toonName = data.character;
			var accountLink = getPoeAccount(data.account)
			var ascendancyIcon = getAscendancyIcon(data.theClass);
	...
	counter = 1;
	results.leagueSFF.tableDataRaceTo100.forEach(function(data) {
		if (counter <= 5) {
			toonName = data.character;
			var accountLink = getPoeAccount(data.account)
			var ascendancyIcon = getAscendancyIcon(data.theClass);
	...
	counter = 1;
	results.leagueHCSFF.tableDataRaceTo100.forEach(function(data) {
		if (counter <= 5) {
			toonName = data.character;
			var accountLink = getPoeAccount(data.account)
			var ascendancyIcon = getAscendancyIcon(data.theClass);
	...
	$("#table1CardTitle").append(
			results.leagueStd.tableDataDelve[0].leagueDifficulty);
	$("#table2CardTitle").append(
			results.leagueHC.tableDataDelve[0].leagueDifficulty);
	$("#table4CardTitle").append(
			results.leagueSFF.tableDataDelve[0].leagueDifficulty);
	$("#table5CardTitle").append(
			results.leagueHCSFF.tableDataDelve[0].leagueDifficulty);
	$("#table6CardTitle").append(
			results.leagueStd.tableDataUberLabTopTen[0].leagueDifficulty);
	$("#table7CardTitle").append(
			results.leagueHC.tableDataUberLabTopTen[0].leagueDifficulty);
	$("#table8CardTitle").append(
			results.leagueSFF.tableDataUberLabTopTen[0].leagueDifficulty);
	$("#table9CardTitle").append(
			results.leagueHCSFF.tableDataUberLabTopTen[0].leagueDifficulty);
	$("#table10CardTitle").append(
			results.leagueStd.tableDataRaceTo100[0].leagueDifficulty);
	$("#table11CardTitle").append(
			results.leagueHC.tableDataRaceTo100[0].leagueDifficulty);
	$("#table12CardTitle").append(
			results.leagueSFF.tableDataRaceTo100[0].leagueDifficulty);
	$("#table13CardTitle").append(
			results.leagueHCSFF.tableDataRaceTo100[0].leagueDifficulty);
